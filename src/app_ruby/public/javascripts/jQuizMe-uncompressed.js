...
(function($){	
	...
	_lang = {
			ans:{	// _lang.ans are shown during the display of .q-result, the answer result.
				corrAns: "Prawidłowa dopowiedź:",
				praise: 'Wspaniale!',
				whyAns: "Info:",
				yourAns: "Twoja odpowiedź:"
			},
			btn:{	// [ "text", "title" ]
				begin: [ "Rozpocznij Quiz" ],
				check: [ "Sprawdź", "Sprawdź swoją odpowiedz" ],
				del: [ "Usuń", "Usuń quiz" ],
				help: [ "Pomoc", 'Kliknij po pomoc'],
				next: [ "Dalej", "Nastepne pytanie" ],
				restart: [ "Restart", "Restart quit" ],
				details: [ "Szczegóły", "Podgląd" ],
				review: [ "Podgląd", "Podgląd pytań" ],
				showOnlyMissed: [ " *", "Pokaż tylko opuszczone pytania." ],
				quit: [ "Wyjście", "Wyjście z quizu" ],
				quitNo: [ "->", "Cofnij" ],
				quitYes: [ '', "Tak, wyjść" ]
			},
			err:{
				badQType: "Zły typ quizu",
				badKey: " zła wartość.",
				error: "Error",	
				noQType: "Nie ma typu quizu.",
				noQues: "Quiz nie ma pytań.",
				notArr: "Musi być tablicą.",
				notObj: "Invalid quiz data structure"
			},
			stats:{
				right: "Poprawnie",
				rate: "Ocena",
